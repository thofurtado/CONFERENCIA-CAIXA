...
import { ArrowLeft, ShoppingBag, ArrowUpDown, Trash2, Wallet2, Printer, Edit2, Check, X, Filter } from 'lucide-react';
...
export function DetalheLote({ loteAtivo, resumoLote, onVoltar, onAdicionarLancamento, onRemoverLancamento, onEditarLancamento, onEditarAbertura }: DetalheLoteProps) {
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {editandoAbertura ? (
                                <div className="flex items-center gap-1">
                                    ...
                                    />
                                    <button onClick={salvarEdicaoAbertura} className="text-green-600 p-1">
                                        <Check size={14} />
                                    </button>
                                    <button onClick={cancelarEdicaoAbertura} className="text-red-600 p-1">
                                        <X size={14} />
                                    </button>
                                </div>
                            ) : (
                        ...
                        <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-4 grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                                ...
                                <input
                                    type="text"
                                    value={filtro.mesa}
                                    onChange={e => setFiltro({ ...filtro, mesa: e.target.value })}
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    value={filtro.forma}
                                    onChange={e => setFiltro({ ...filtro, forma: e.target.value })}
                                        ...
                                        <tr key={l.id} className="hover:bg-zinc-50 transition-colors">
                                            {editandoId === l.id ? (
                                                <>
                                                    <td className="p-2">
                                                        <input
                                                            ...
                                                            className="w-full px-2 py-1 border border-blue-300 rounded text-sm font-bold"
                                                        />
                                                    </td>
                                                    <td className="p-2">
                                                        <select
                                                            ...
                                                            className="w-full px-2 py-1 border border-blue-300 rounded text-[9px] font-bold"
                                                        >
                                                    ...
                                                    <td className="p-2">
                                                        <input
                                                            ...
                                                            className="w-full px-2 py-1 border border-blue-300 rounded text-sm font-bold text-right"
                                                        />
                                                    </td>
                                                    <td className="p-2">
                                                        <div className="flex gap-1 justify-end">
                                                            <button onClick={salvarEdicao} className="text-green-600 hover:text-green-700 p-1">
                                                                <Check size={18} />
                                                            </button>
                                                            <button onClick={cancelarEdicao} className="text-red-500 hover:text-red-600 p-1">
                                                                <X size={18} />
                                                            </button>
                                                        </div>
                                                    </td>
                                                ...
                                                <>
                                                    ...
                                                    <td className="p-4">
                                                        <div className="flex gap-1 justify-end">
                                                            <button onClick={() => iniciarEdicao(l)} className="text-zinc-300 hover:text-blue-500 p-2">
                                                                <Edit2 size={16} />
                                                            </button>
                                                            <button onClick={() => onRemoverLancamento(l.id)} className="text-zinc-200 hover:text-red-500 p-2">
                                                                <Trash2 size={18} />
                                                            </button>
                                                        </div>
                                                    </td>
